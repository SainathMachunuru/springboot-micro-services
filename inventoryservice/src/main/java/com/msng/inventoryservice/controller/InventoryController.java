package com.msng.inventoryservice.controller;

import com.msng.inventoryservice.entity.InventoryItem;
import com.msng.inventoryservice.repository.InventoryItemRepository;
...
public class InventoryController {
    ...
    public ResponseEntity<InventoryItem> findInventoryByProductCode(@PathVariable("productCode") String productCode) {
        ...
        if (inventoryItem.getAvailableQuantity() > 0) {
